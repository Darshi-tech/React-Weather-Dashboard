   ...
   <form className="singupform" method="post"  name="userRegistrationForm"  onSubmit= {this.submituserRegistrationForm} >
      ...
      <Router>
         <div className="main-button">
            <button type="reset" className="btn btn-secondry" value="Cancel"> Cancel</button>
            <button type="submit" className="btn float-left mb-3 d-block" value="Save" onClick={ this.handleSubmit }>
               <Link to={'/Profile'} title="Sign Up" altTitle="Or here">
               Save</Link>
            </button>
         </div>
         <Switch>
